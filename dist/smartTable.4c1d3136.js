! function(t) { var e = {};
  ...
  function n(t, e, r) { for (var a = 0; a < e.length; a++) { var o = { css: e[a][1], media: e[a][2], sourceMap: e[a][3] };
      l[t][a] ? l[t][a](o) : l[t].push(u(o, r)) } }

  function s(t) { var e = document.createElement("style"),
  ...
  function u(t, e) { var r, a, o; if (e.singleton) { var i = p++;
      r = b || (b = s(e)), a = c.bind(null, r, i, !1), o = c.bind(null, r, i, !0) } else r = s(e), a = h.bind(null, r, e), o = function() {! function(t) { if (null === t.parentNode) return !1;
        t.parentNode.removeChild(t) }(r) }; return a(t),
      function(e) { if (e) { if (e.css === t.css && e.media === t.media && e.sourceMap === t.sourceMap) return;
          a(t = e) } else o() } }
  t.exports = function(t, e, r) { return (r = r || {}).singleton || "boolean" == typeof r.singleton || (r.singleton = o()), t = r.base ? t + r.base : t, e = e || [], l[t] || (l[t] = []), n(t, e, r),
      function(e) { if (e = e || [], "[object Array]" === Object.prototype.toString.call(e)) { l[t] || (l[t] = []), n(t, e, r); for (var a = e.length; a < l[t].length; a++) l[t][a]();
  ...
  t.exports = function(t) { var e = []; return e.toString = function() { return this.map((function(e) { var r = function(t, e) { var r = t[1] || "",
            a = t[3]; if (!a) return r; if (e && "function" == typeof btoa) { var o = (l = a, n = btoa(unescape(encodeURIComponent(JSON.stringify(l)))), s = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(n), "/*# ".concat(s, " */")),
  ...
  function a(t, e, r, a) { if (!t.data || t.data.length < 1) return; let i = function t(e, r, a, i) { if (e.length <= 1) return e; let l = [],
        ...
        s = e.length,
        d = Math.floor(s / 2),
        f = e.splice(d, 1)[0]; for (let t = 0; t < s - 1; t++) o(e[t][r], f[r], a, i) ? l.push(e[t]) : n.push(e[t]); return t(l, r, a, i).concat(f, t(n, r, a, i)) }(JSON.parse(JSON.stringify(t.data)), e, r, a);
  ...
  function n(t, e) { return e.forEach(e => { t.appendChild(e) }), t }

  function s(t, e) { return t.cloneNode(e) }

  function d(t, e) { return t.querySelector(e) }

  function f(t, e) { return t.querySelectorAll(e) }

  function c(t) { let e = t.childNodes,
      r = i("div", "smart-table_cell"); for (; e.length;) l(r, e[0]);
    l(t, r) }

  function h(t, e, r, a) { let o = i("div", t),
      s = i("table", "smart-table_" + r); return s.style.width = e.size.tabelWidth - 1 + "px", n(s, [u(e.colgroup), a]), l(o, s), o }

  function b(t, e) { let r = u(t.colgroup);
    e.replaceChild(r, d(e, "colgroup")) }

  function p(t, e, r) { return Number.parseInt(t.getAttribute(e) || r) }

  function u(t) { if (!t) return; let e = i("colgroup"); return t.forEach(t => { let r = i("col");
      r.setAttribute("width", t), l(e, r) }), e }

  function m(t, e, r) { if (e) { let a = d(e, ".smart-table_header"),
        o = d(e, ".smart-table_body");
      b(t, a), b(t, o); const i = f(d(e, "tr"), "th"); let l = 0;
      i.forEach((e, r) => { "is-hidden" != e.className && (l += t.colgroup[r]) }), e.style.width = l + "px", a.style.width = r + "px", o.style.width = r + "px" } }

  function g(t) { this instanceof g || console.error("Smart Table is a constructor and should be called with the `new` keyword"), window.addEventListener("load", () => { setTimeout(this._init(t), 0) }) }
  g.prototype._init = function(t = {}) { t.selector || console.error("Smart Table init need a selector"); const e = this;
    e.$options = t; const r = t.selector && d(document, String(t.selector).trim()); if (!r) return; const o = d(r, "table"); if (!o) return;
    r.classList.add("smart-table"), t.size && r.classList.add("smart-table-custom-" + t.size), t.align && r.classList.add("smart-table-custom-" + t.align); const u = d(o, "thead"),
      g = d(o, "tbody");
    f(u, "th").forEach(t => c(t)), f(g, "td").forEach(t => c(t)), o.hasAttribute("stripe") && g.classList.add("stripe"), o.style.width = "100%", e.$root = r; const x = u.offsetHeight,
      A = o.offsetHeight; let w = t.height; var y, v; if (w = ("function" == typeof w ? w() : w) || A, w = w > x ? w : x + 100, e.size = { theadHeight: x, tbodyHeight: w - x, tabelWidth: o.offsetWidth, wrapperWidth: o.offsetWidth, tableHeight: w, fixWrapperHeigth: A > w ? w : A }, e.props = function(t) { let e = {},
          r = [],
          a = f(t, "tr"); return a.forEach((t, e) => { let a = r[e] || [];
          f(t, "th").forEach(t => { let o = p(t, "rowspan", 1),
              i = p(t, "colspan", 1),
              ...
              for (let t = 1; t < o; t++) { let a = r[e + t] || []; for (let t = 0; t < i; t++) a[l + t] = 0;
                r[e + t] = a }
            r[e] = a }) }), e.theadLength = a.length, e.shapes = r, e }(u), e.colgroup = function(t, e, r) { let a = []; return 1 === r ? f(d(t, "tr"), "th").forEach(t => { let e = p(t, "width", 0);
          0 === e && (e = t.offsetWidth > 80 ? t.offsetWidth : 80), a.push(e) }) : f(d(e, "tr"), "td").forEach(t => { let e = t.offsetWidth;
          e += e < 50 ? 10 : e >= 50 && e < 100 ? 30 : 40, a.push(e) }), a }(u, g, e.props.theadLength), e.size.tabelWidth = o.style.width = e.colgroup.reduce((t, e) => t + e), e.hasVerticalScroll = w < o.offsetHeight, e.hasHorizontalScroll = r.offsetWidth < e.size.tabelWidth, function(t, e) { let { colgroup: r, props: a } = e; const o = r.length; let i = { thead: [], tbody: [], width: 0 },
          l = { thead: [], tbody: [], width: 0 }; const n = f(d(t, "tr"), "th"),
          s = n.length; let c = 0; if (0 !== s) { if (n[0].hasAttribute("fixed"))
            for (let t = 0; t < s - 1; t++)
              if (n[t].hasAttribute("fixed")) { c = t, i.thead.push("field-" + t); let e = p(n[t], "colspan", 1); for (let a = 0; a < e; a++) i.tbody.push("field-" + (t + a)), i.width = i.width + r[t + a] }
          if (n[s - 1].hasAttribute("fixed")) { let t = 0; for (let e = s - 1; e > 0; e--)
              if (n[e].hasAttribute("fixed")) { if (e === c) break;
                l.thead.push("field-" + e); let a = p(n[e], "colspan", 1); for (let e = 0; e < a; e++) t++, l.tbody.push("field-" + (o - t)), l.width = l.width + r[o - t] } } }
        a.fixedLeft = i, a.fixedRight = l }(u, e), e.$theadWrapper = h("smart-table_header-wrapper", e, "header", u), e.$tbodyWrapper = h("smart-table_body-wrapper", e, "body", g), n(r, [e.$theadWrapper, e.$tbodyWrapper]), e.size.theadHeight = u.offsetHeight, e.size.tbodyHeight = w - u.offsetHeight, y = o.parentNode, v = o, y.removeChild(v), function(t, e, r) { const { fixedLeft: a, fixedRight: o } = t.props; let c = 320; if (f(t.$root, ".smart-table_body-wrapper").forEach(e => { e.style.height = t.size.tbodyHeight + "px" }), a.thead.length > 0) { c = c > a.width ? c : a.width; let o = s(e, !0);
          f(d(o, "tr"), "th").forEach((t, e) => {-1 === a.thead.indexOf("field-" + e) && t.classList.add("is-hidden") }); let b = h("smart-table_fixed-header-wrapper", t, "header", o),
            p = s(r, !0);
          f(p, "tr").forEach(t => { f(t, "td").forEach((t, e) => {-1 === a.tbody.indexOf("field-" + e) && t.classList.add("is-hidden") }) }); let u = h("smart-table_fixed-body-wrapper", t, "body", p);
          u.style.top = t.size.theadHeight + "px", u.style.height = t.size.tbodyHeight - (t.hasHorizontalScroll ? 8 : 0) + "px"; let m = i("div", "smart-table_fixed");
          n(m, [b, u]), m.style.width = a.width + "px", m.style.height = t.size.fixWrapperHeigth - (t.hasHorizontalScroll ? 8 : 0) + "px", l(t.$root, m), t.$fixedLeft = u } if (o.thead.length > 0) { c += o.width; let a = s(e, !0);
          f(d(a, "tr"), "th").forEach((t, e) => {-1 === o.thead.indexOf("field-" + e) && t.classList.add("is-hidden") }); let b = h("smart-table_fixed-header-wrapper", t, "header", a),
            p = s(r, !0);
          f(p, "tr").forEach(t => { f(t, "td").forEach((t, e) => {-1 === o.tbody.indexOf("field-" + e) && t.classList.add("is-hidden") }) }); let u = h("smart-table_fixed-body-wrapper", t, "body", p);
          u.style.top = t.size.theadHeight + "px", u.style.height = t.size.tbodyHeight - (t.hasHorizontalScroll ? 8 : 0) + "px"; let m = i("div", "smart-table_fixed-right"); if (m.style.right = (t.hasVerticalScroll ? 8 : 0) + "px", n(m, [b, u]), m.style.width = o.width + "px", m.style.height = t.size.fixWrapperHeigth - (t.hasHorizontalScroll ? 8 : 0) + "px", l(t.$root, m), t.$fixedRight = u, t.hasVerticalScroll) { let e = i("div", "smart-table_fixed-right-patch");
            e.style.width = "8px", e.style.height = t.size.theadHeight + "px", l(t.$root, e) } }
        t.$root.style.minWidth = c + "px" }(e, u, g), e.data = function(t, e) { let r = t.$fixedLeft && f(t.$fixedLeft, "tbody tr"),
          a = t.$fixedRight && f(t.$fixedRight, "tbody tr"),
          o = []; return f(e, "tr").forEach((t, e) => { if (!t.hasAttribute("unsort")) { let i = { $el: t, $fixedLeftEl: r && r[e], $fixedRightEl: a && a[e], $key: "$$rowkey" + e };
            f(t, "td .cell").forEach((t, e) => { i["field-" + e] = t.innerHTML }), o.push(i) } }), o }(e, g), function(t) { let e = Array.from(f(t.$root, "th[sort]"));
        0 !== e.length && e.forEach(r => { r.addEventListener("click", o => { o.stopPropagation(); let i = "ASC",
            ...
            r.classList.contains("asc") ? (r.classList.remove("asc"), r.classList.add("desc"), i = "DESC") : (r.classList.remove("desc"), r.classList.add("asc")), e = e.map(t => (r != t && t.classList.remove("asc", "desc"), t)), a(t, r.getAttribute("sortkey"), i, l) }) }) }(e), function(t) { t.$tbodyWrapper.addEventListener("scroll", () => function(t) {! function(t, e) { let r, a = 0; return function() { let o = this,
              ...
              function n() { a = (new Date).getTime(), e.apply(o, l) }
              r && clearTimeout(r), i > t ? n() : r = setTimeout(n, t - i) } }(20, () => { t.$theadWrapper.scrollLeft = t.$tbodyWrapper.scrollLeft, t.$fixedLeft && (t.$fixedLeft.scrollTop = t.$tbodyWrapper.scrollTop), t.$fixedRight && (t.$fixedRight.scrollTop = t.$tbodyWrapper.scrollTop) })() }(t), { passive: !0 }), window.addEventListener("resize", function(t, e) { let r = null; return function() { null !== r && clearTimeout(r), r = setTimeout(e, t) } }(600, () => { let e = t.$root,
            r = t.size.wrapperWidth,
            a = t.size.tabelWidth,
            o = e.offsetWidth,
            i = parseInt(a * (o / r)),
            l = d(t.$theadWrapper, ".smart-table_header"),
            n = d(t.$tbodyWrapper, ".smart-table_body");
          t.colgroup.forEach((function(e, r) { t.colgroup[r] = parseInt(i * (e / a)) + 1 })), t.size.wrapperWidth = o, t.size.tabelWidth = i, l.style.width = i + "px", n.style.width = i + "px", b(t, l), b(t, n), m(t, d(e, ".smart-table_fixed"), i), m(t, d(e, ".smart-table_fixed-right"), i) })); let e = f(t.$tbodyWrapper, "tr"),
          r = f(t.$root, ".smart-table_fixed .smart-table_fixed-body-wrapper tr"),
          a = f(t.$root, ".smart-table_fixed-right .smart-table_fixed-body-wrapper tr");
      ...
      t.setAttribute("width", 8), t.setAttribute("rowspan", e.props.shapes.length), l(d(u, "tr"), t) } }; var x = g;
  window.SmartTable = x }]);